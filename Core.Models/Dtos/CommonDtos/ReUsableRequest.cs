namespace Core.Models.Dtos.CommonDtos
{
    public class ReUsableRequest
    {
        ...
        public string? VendorPacks { get; set; }
        ...
        public int CustomerAppPreferenceId { get; set; }

        public int AccountManagerId { get; set; }

        public string? AccMgrId { get; set; }
        ...
        public int MoCampId { get; set; }

        public string? MoCampIds { get; set; }
