...
!function ($) {
    ...
    $(document).ready(function(){
        ...
        var table = $('.gridtable');
        var lgval = document.getElementById("hdnLang").value == "lngArbic" ? "بحث" : "Search:";
        var slenghmenu = (document.getElementById("hdnLang").value == "lngArbic" ? ("تبين" + " _MENU_ " + "إدخالات") : "Show _MENU_ entries");
        var sinfo = (document.getElementById("hdnLang").value == "lngArbic" ? ("عرض" + " _START_ " + " إلى " + " _END_ " + " من " + " _TOTAL_ " + "إدخالات") : "Showing _START_ to _END_ of _TOTAL_ entries");
        var nodatamsg = document.getElementById("hdnLang").value == "lngArbic" ? "لا تتوفر بيانات في الجدول" : "No data available in table";
        var nomatchmsg = document.getElementById("hdnLang").value == "lngArbic" ? "لم يتم العثور على سجلات مطابقة" : "No matching records found";
        var sInfoFiltertext = document.getElementById("hdnLang").value == "lngArbic" ? "(تمت تصفيتها من _MAX_ إجمالي الإدخالات)" : "(filtered from _MAX_ total entries)";
        var sInfoempt = document.getElementById("hdnLang").value == "lngArbic" ? "عرض 0 إلى 0 من 0 إدخالات" : "Showing 0 to 0 of 0 entries";
        ...
        table.dataTable({
            ...
            "language": {
                "search": lgval,
                "sLengthMenu": slenghmenu,
                "emptyTable": nodatamsg,
                "sZeroRecords": nomatchmsg,
                "sInfoFiltered": sInfoFiltertext,
                "sInfoEmpty": sInfoempt,
                "sInfo": sinfo,
                "paginate": {
    ...
    $(document).on('nifty.ready', function(){
        ...
        $('a.label-warning').on('click', function () {
            ...
            $('#CheckerUpdation .panel-footer').show();
        ...
        $('.gridtable .fa-pencil-square-o, .dataTable .fa-pencil-square-o').on('click', function () {
            ...
            $('.error').remove();
            $(':input').removeAttr('style', 'border: 1px solid red !important');
        ...
        $('#ADDForm button[type="reset"]').on('click', function () {
            ...
            //clear the hidden fields : issue with new template integration            // $('input[type=hidden]').val("");
            //debugger;
            var childControls = Enumerable.From($('input[type=hidden]'))
                                                .Where(function (x) {
        ...
        $(menulinks).each(function (event) {
            ...
            if (urlRegExp.test(this.href.replace(/\/$/, ''))) {
               $(this).addClass('current-item');
                ...
                $(this).closest('ul.collapse').addClass('in subitem').parent('ul.collapse').addClass('in');
                setTimeout(function () {
                    $('.subitem').parent().parent('ul.collapse').addClass('in');
                    //$(this).closest('li.active  a').addClass('current-ffff');
                    $(CurrentItem).closest('li.active').addClass('current-item');
                    $('li.current-item > a').addClass('current-item');
                }, 1000);
...
!function ($) {
    ...
    var $menulink               = null,
        ...
        bindSmallNav = function(){
            var hidePopover, $menulink = $('#mainnav-menu > ul > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]');
        ...
        unbindSmallNav = function(){
            var colapsed = $('#mainnav-menu ul').find('.collapse');
            if(colapsed.length){
    ...
    //},
        ...
        methods = {
            ...
            'bind': function () {
                ...
                var menu = $('#mainnav-menu ul');

                //menu.$('#mainnav-menu ul li')[1].addClass('fa-check');
               // menu.$('li')[2].addClass('fa-exclamation');
                $('#mainnav-menu ul > li:nth-child(2) i').addClass('fa-check');
                if (menu.length == 0) return false;

                $menulink               = $('#mainnav-menu > ul > li > a, #mainnav-menu-wrap .mainnav-widget a[data-toggle="menu-widget"]');
